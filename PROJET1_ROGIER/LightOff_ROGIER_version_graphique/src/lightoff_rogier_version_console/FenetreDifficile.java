 ...
 * @author Evan1204
 */
public class FenetreDifficile extends javax.swing.JFrame {
    GrilleDeJeu grille;
    int nbCoups;
    int i;
    int j;
    /**
     * Creates new form FenetreDifficile
     */
    public FenetreDifficile() {
        initComponents();
                int nbLignes = 10;
        int nbColonnes = 10;
        getContentPane().add(PanneauGrille, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 130, nbColonnes * 40, nbLignes * 40));
        this.pack();
        this.revalidate();
        ...
        getContentPane().add(PanneauBoutonsVerticaux, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 130, 1 * 40, nbLignes * 40));
        this.pack();
        this.revalidate();
        ...
        getContentPane().add(PanneauBoutonsHorizontaux, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 80, nbColonnes * 40,1 * 40));
        this.pack();
        this.revalidate();
    ...
    private void initComponents() {
        ...
        getContentPane().add(PanneauGrille, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 120, 250, 260));
        ...
        getContentPane().add(PanneauBoutonsHorizontaux, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 70, 250, 30));
        ...
        getContentPane().add(PanneauBoutonsVerticaux, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 130, 40, 240));
        ...
        btnColonne0.setText("jButton11");
        btnColonne0.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnColonne0ActionPerformed(evt);
            }
        });
        getContentPane().add(btnColonne0, new org.netbeans.lib.awtextra.AbsoluteConstraints(2000, 0, 20, 20));
        ...
        getContentPane().add(PanneauBoutonDiagSup, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 70, 40, 40));
        ...
        getContentPane().add(PanneauBoutonDiagInf, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 70, 40, 40));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FenetreDifficile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FenetreDifficile().setVisible(true);
            }
        });
    }
