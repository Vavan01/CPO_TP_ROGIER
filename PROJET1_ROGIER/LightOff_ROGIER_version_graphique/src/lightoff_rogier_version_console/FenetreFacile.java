 ...
 * @author Evan1204
 */
public final class FenetreFacile extends javax.swing.JFrame {
    GrilleDeJeu grille;
    int nbCoups;
    int i;
    int j;
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnLigne0, new org.netbeans.lib.awtextra.AbsoluteConstraints(2000, 2000, 20, 20));
        ...
        getContentPane().add(btnLigne1, new org.netbeans.lib.awtextra.AbsoluteConstraints(2000, 2000, 20, 20));
        ...
        getContentPane().add(btnLigne2, new org.netbeans.lib.awtextra.AbsoluteConstraints(2000, 2000, 20, 20));
        ...
        getContentPane().add(btnLigne3, new org.netbeans.lib.awtextra.AbsoluteConstraints(2000, 2000, 20, 20));
        ...
        getContentPane().add(btnLigne4, new org.netbeans.lib.awtextra.AbsoluteConstraints(2000, 2000, 20, 20));
        ...
        getContentPane().add(btnLigne5, new org.netbeans.lib.awtextra.AbsoluteConstraints(2000, 2000, 20, 20));
        ...
        getContentPane().add(btnLigne6, new org.netbeans.lib.awtextra.AbsoluteConstraints(2000, 2000, 20, 20));
        ...
        getContentPane().add(btnLigne7, new org.netbeans.lib.awtextra.AbsoluteConstraints(2000, 2000, 20, 20));
        ...
        getContentPane().add(btnColonne0, new org.netbeans.lib.awtextra.AbsoluteConstraints(2000, 2000, 20, 20));

        btnColonne1.setText("jButton2");
        btnColonne1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnColonne1ActionPerformed(evt);
            }
        });
        getContentPane().add(btnColonne1, new org.netbeans.lib.awtextra.AbsoluteConstraints(2000, 2000, 20, 20));

        btnColonne2.setText("jButton3");
        btnColonne2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnColonne2ActionPerformed(evt);
            }
        });
        getContentPane().add(btnColonne2, new org.netbeans.lib.awtextra.AbsoluteConstraints(2000, 2000, 20, 20));

        btnColonne3.setText("jButton4");
        btnColonne3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnColonne3ActionPerformed(evt);
            }
        });
        getContentPane().add(btnColonne3, new org.netbeans.lib.awtextra.AbsoluteConstraints(2000, 2000, 20, 20));

        btnColonne4.setText("jButton5");
        btnColonne4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnColonne4ActionPerformed(evt);
            }
        });
        getContentPane().add(btnColonne4, new org.netbeans.lib.awtextra.AbsoluteConstraints(2000, 2000, 20, 20));

        btnColonne5.setText("jButton6");
        btnColonne5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnColonne5ActionPerformed(evt);
            }
        });
        getContentPane().add(btnColonne5, new org.netbeans.lib.awtextra.AbsoluteConstraints(2000, 2000, 20, 20));

        btnColonne6.setText("jButton7");
        btnColonne6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnColonne6ActionPerformed(evt);
            }
        });
        getContentPane().add(btnColonne6, new org.netbeans.lib.awtextra.AbsoluteConstraints(2000, 2000, 20, 20));

        btnColonne7.setText("jButton8");
        btnColonne7.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnColonne7ActionPerformed(evt);
            }
        });
        getContentPane().add(btnColonne7, new org.netbeans.lib.awtextra.AbsoluteConstraints(2000, 2000, 20, 20));

        btnDiagInf.setText("jButton9");
        btnDiagInf.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnDiagInfActionPerformed(evt);
            }
        });
        getContentPane().add(btnDiagInf, new org.netbeans.lib.awtextra.AbsoluteConstraints(2050, 1990, 20, 20));

        btnDiagSup.setText("jButton10");
        btnDiagSup.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnDiagSupActionPerformed(evt);
            }
        });
        getContentPane().add(btnDiagSup, new org.netbeans.lib.awtextra.AbsoluteConstraints(2000, 2000, 20, 20));
        ...
        getContentPane().add(PanneauBoutonsVerticaux, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 30, 40, 350));
        ...
        getContentPane().add(PanneauBoutonsHorizontaux, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 30, 50, 360));
        ...
        getContentPane().add(PanneauBoutonDiagSup, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 40, 40));
        ...
        getContentPane().add(PanneauBoutonDiagInf, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 42, 40, 40));
        ...
        getContentPane().add(btnLigne8, new org.netbeans.lib.awtextra.AbsoluteConstraints(2000, 0, 20, 20));
        ...
        getContentPane().add(btnLigne9, new org.netbeans.lib.awtextra.AbsoluteConstraints(2000, 0, 20, 20));

        btnLigne10.setText("jButton2");
        btnLigne10.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnLigne10ActionPerformed(evt);
            }
        });
        getContentPane().add(btnLigne10, new org.netbeans.lib.awtextra.AbsoluteConstraints(2000, 0, 20, 20));

        btnLigne11.setText("jButton3");
        btnLigne11.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnLigne11ActionPerformed(evt);
            }
        });
        getContentPane().add(btnLigne11, new org.netbeans.lib.awtextra.AbsoluteConstraints(2000, 0, 20, 20));
        ...
        getContentPane().add(PanneauGrille, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 20, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FenetreFacile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FenetreFacile().setVisible(true);
            }
        });
    }
